package com.norcode.bukkit.toughanvils.v1_6_R3;
...
public class AnvilLocator implements IAnvilLocator {
	...
	static {
		try {
			...
			anvilWorldField = ContainerAnvil.class.getDeclaredField("h");
			anvilXField = ContainerAnvil.class.getDeclaredField("i");
			anvilYField = ContainerAnvil.class.getDeclaredField("j");
			anvilZField = ContainerAnvil.class.getDeclaredField("k");
